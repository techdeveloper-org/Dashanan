...
| OAQ-10 | DPDP erasure via **crypto-shredding** of an append-only audit store | Proposed, with cited research context (added 2026-09-20) — **still requires legal confirmation, status unchanged** | Resolves a genuine legal/technical conflict, but whether key destruction constitutes erasure under DPDP Act 2023 requires legal confirmation, not an architect's judgment. **Real research context (not a legal opinion):** (1) DPDP Act 2023 Section 12 grants a right to correction/erasure, but it is *conditional and narrower than GDPR's right to be forgotten* — anchored to two specific triggers (consent withdrawal, or cessation of the purpose data was collected for), and a Data Fiduciary may refuse erasure if retention is required by law (e.g. audit/tax records) [DPDPA Section 12 with interpretation](https://www.dpdpa.com/dpdpa2023/chapter-3/section12.html), [SCC Times, "Data Deletion — A Key Compliance under the DPDP Act 2023"](https://www.scconline.com/blog/post/2025/06/27/data-deletion-a-key-compliance-under-the-digital-personal-data-protection-act-2023/). This matters for Zone 7 specifically: an append-only *audit* record is plausibly retained-for-compliance under DPDP's own exception, which is a different legal question from whether crypto-shredding *counts as* erasure at all. (2) Internationally, crypto-shredding is an accepted GDPR Article 17 compliance mechanism — France's CNIL has acknowledged encryption-key-destruction approaches in its blockchain guidance [Conduktor, "Crypto Shredding for Kafka: GDPR-Compliant Data Deletion"](https://www.conduktor.io/glossary/crypto-shredding-for-kafka), [VeritasChain, "Crypto-Shredding: GDPR + MiFID II Compliance"](https://veritaschain.org/blog/posts/2026-01-18-crypto-shredding-gdpr-mifid-ii-reconciliation/) — but no equivalent Indian regulatory guidance (MeitY or otherwise) endorsing crypto-shredding specifically under DPDP was found in this research pass. **This upgrades the OAQ from "no research" to "informed, with real citations" — it does not close it; real counsel confirmation is still required before this can be adopted.** |
